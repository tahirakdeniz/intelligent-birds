...
public class FlowerArea : MonoBehaviour
{
    ...
    private List<GameObject> _flowerPlants = new();

    // A lookup dictionary for looking up a flower from a nectar collider
    private Dictionary<Collider, Flower> _nectarFlowerDictionary = new();

    /// <summary>
    /// The list of all flowers in the flower area
    /// </summary>
    public List<Flower> Flowers { get; } = new();
    ...
    {
        return _nectarFlowerDictionary[nectarCollider];
    }
