...
public class HummingbirdAgent : Agent
{
    ...
    private void Heuristic(float[] actionsOut)
    {
    ...
    {
        var actionsArray = actionsOut.ContinuousActions.Array;
        Heuristic(actionsArray);
    }
    ...
    private void TriggerEnterOrStay(Collider other)
    {
        ...
        if (!other.CompareTag("nectar")) return;
        ...
        bool isCloseEnough = (Vector3.Distance(beakTip.position, closestPointToBeakTip) < BeakTipRadius);
